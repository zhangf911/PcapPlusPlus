 ...
 */
class PCAPPP_EXPORT ArpLayer: public Layer {
public:
	/**
	 ...
	 */
	inline MacAddress getSenderMacAddress() {
	 ...
	 */
	inline MacAddress getTargetMacAddress() {
	 ...
	 */
	inline IPv4Address getSenderIpAddr() {
	 ...
	 */
	inline IPv4Address getTargetIpAddr() {
